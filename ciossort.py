...
def imagelookup (imagecode):
	...
	if imagecode == 'a2i5k8s':
		...
		subdirectory = 'ADVANCED ENTERPRISE SERVICES WITHOUT CRYPTO'
		...
		subdirectory = 'ADVANCED IP SERVICES WITHOUT CRYPTO'
		...
		subdirectory = 'ENTERPRISE BASE WITHOUT CRYPTO'
	elif imagecode == 'entbasek9':
		subdirectory = 'ENTERPRISE BASE'
	elif imagecode == 'entservices':
		subdirectory = 'ENTERPRISE SERVICES WITHOUT CRYPTO'
		...
		subdirectory = 'IP SERVICES WITHOUT CRYPTO'
	elif imagecode == 'i5k2':
		...
		subdirectory = 'LONG-REACH ETHERNET WITHOUT CRYPTO'
	elif imagecode == 'i6q4l2':
		subdirectory = 'LAYER 2'
	elif imagecode == 'i6s':
		subdirectory = 'IP SUBSET-VOICE'
	elif imagecode == 'i9':
		subdirectory = 'IP BASE WITHOUT CRYPTO'
	elif imagecode == 'i9k2':
		...
		subdirectory = 'IP BASE WITHOUT CRYPTO WITH EXPRESS SETUP'
		...
		subdirectory = 'IP SERVICES WITHOUT CRYPTO WITH EXPRESS SETUP'
		...
		subdirectory = 'IP VOICE WITHOUT CRYPTO'
		...
		subdirectory = 'UNIVERSAL DATA WITHOUT CRYPTO'
	elif imagecode == 'universal_lite':
		subdirectory = 'UNIVERSAL LITE WITHOUT CRYPTO'
