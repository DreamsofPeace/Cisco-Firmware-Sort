...
def product(prodcode):
    prod_map = {
        ...
        "ap1g8"              : "WIRELESS/Access-Point/Aironet AP1G9 (9172i)",
        ...
        "ap3g3"              : "WIRELESS/Access-Point/Aironet AP3G4-(9176-9178)",
        ...
        "CT7500"             : "WIRELESS/CONTROLLER/7500",
        "CT8500"             : "WIRELESS/CONTROLLER/8500",
        "LOC2700"            : "WIRELESS/CONTROLLER/2700-Location",
        "WLCM"               : "WIRELESS/CONTROLLER/NM-NME",
        "SRE"                : "WIRELESS/CONTROLLER/NM-SRE",
        "CTVM"               : "WIRELESS/CONTROLLER/Virtual",
        "WLC2006"            : "WIRELESS/CONTROLLER/2006",
        "WLC2100"            : "WIRELESS/CONTROLLER/2100",
        "WLC4100"            : "WIRELESS/CONTROLLER/4100",
        "WLC4400"            : "WIRELESS/CONTROLLER/4400",
        "WLC7500"            : "WIRELESS/CONTROLLER/7500",
        "CT8540"             : "WIRELESS/CONTROLLER/8540",
...
def fileprocessorrommon(filename):
    ...
    pattern_map = [
        ...
        # ISR1100
        (["isr1100-bootloader"], "c1100router"),
...
#    logging.debug("Sub:    is_security_file")
    ...
    security_prefixes = (
        ...
        "win_spw", "zeus", "SNS-38xx", "acnvmcollector"
    )
...
#    logging.debug("Sub:    is_iosxe_file")
    ...
    iosxe_prefixes = (
        ...
        "vg400", "vg420", "vg450", "vg4x0", "ASR1K-fpga_prog",
        "isr-hw-programmables", "nim_vab_phy_fw_", "cg-", "CW9800"
    )
