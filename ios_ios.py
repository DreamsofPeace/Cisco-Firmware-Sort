...
def fileprocessorios (filename):
    logging.debug("Module: ios_ios")
    logging.debug("Sub:    fileprocessorios")
    ...
    filename.startswith ("s72033") and splitbydot[2].startswith ("SR")
        ...
        ios_classical (filename,prodname,imagecode)
    ...
    filename.startswith ("ir800")
        ...
        prodname = product(splitbydash[0])
        imagecode = imagelookup(splitbydash[1])
        ios_spa (filename,prodname,imagecode)
...
def ios_spa (filename, prodname, imagecode):
    logging.debug("Sub:    ios_spa")
...
def ios_classical (filename, prodname, imagecode):
    logging.debug("Sub:    ios_classical")
