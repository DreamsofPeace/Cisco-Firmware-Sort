...
def setup_logging():
    logging.basicConfig(
        level=logging.DEBUG,  # Enable DEBUG level globally
...
def toplevel(filename):
    ...
    if DEBUG:
        ...
        logging.debug("Subroutine - toplevel")
...
if __name__ == "__main__":
    ...
    parser.add_argument('-d1','--debug1',         help='Debug Info', action='store_true', required=False)
